...
public class Trace extends Figure implements IDataProviderListener,
         ...
         */
        final protected boolean use_advanced_graphics = Preferences
                        .useAdvancedGraphics();
        ...
        protected void drawYErrorArea(final Graphics graphics, final ISample predp,
                                ...
                                for (int i = startIndex; i <= endIndex; i++) {
                                        ...
                                        if (dpInXRange && valueIsNaN) {
                                                Point markPos = new Point(
                                                                ...
                                                                yAxis.getValuePosition(
                                                                                xAxis.getTickLabelSide() == LabelSide.Primary ? yAxis
