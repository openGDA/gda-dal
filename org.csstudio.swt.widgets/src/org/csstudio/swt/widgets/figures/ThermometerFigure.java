...
public class ThermometerFigure extends AbstractLinearMarkedFigure {	
	...
	class Bulb extends Ellipse {
		...
		private final Color EFFECT3D_BULB_COLOR = XYGraphMediaFactory.getInstance().getColor(
				new RGB(140, 140, 140));
		public Bulb() {
			super();
			setOutline(true);
	...
	class Pipe extends RoundedRectangle {		
		...
		private final Color EFFECT3D_PIPE_COLOR = XYGraphMediaFactory.getInstance().getColor(
				new RGB(160, 160, 160));
		public Pipe() {
			super();
			setOutline(true);
