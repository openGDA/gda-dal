...
/**
 * @author Sven Wende @version $Revision$ @deprecated Use {@link ValueType} instead!
 */
@Deprecated
public enum DalPropertyTypes {
	...
	/**
	 * Creates an instance of this class from a string representation. @param portableString Required. @return The instance that is represented by the string or
	 * null
	 */
